upload_content = [
  ...
  { content = "shabi, dog! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "dai shabi, dog! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
